...
namespace Keyfactor.Extensions.Orchestrator.F5Orchestrator
{
    public class F5Client
    {
        ...
        public void AddEntry(string partition, string name, string b64Certificate, string certificatePassword, bool AutoGenerateAlias, string AutoGeneratedAliasFormat)
        {
            LogHandlerCommon.MethodEntry(logger, CertificateStore, "AddEntry");
            
            name = AutoGenerateAlias ? CalculateAlias(b64Certificate, AutoGeneratedAliasFormat) : name;
            AddEntry(partition, name, b64Certificate, certificatePassword);
        ...
        public void ReplaceEntry(string partition, string name, string b64Certificate, string certificatePassword, bool AutoGenerateAlias, string AutoGeneratedAliasFormat, bool KeepSameAliasOnRenewal)
        {
            LogHandlerCommon.MethodEntry(logger, CertificateStore, "ReplaceEntry");

            string newName = AutoGenerateAlias && !KeepSameAliasOnRenewal ? CalculateAlias(b64Certificate, AutoGeneratedAliasFormat) : name;
        ...
        private string CalculateAlias(string certContents, string password)
        {
            LogHandlerCommon.MethodEntry(logger, JobConfig.CertificateStoreDetails, "CalculateAlias");
            ...
            LogHandlerCommon.MethodExit(logger, JobConfig.CertificateStoreDetails, "CalculateAlias");
            return alias;
        }
