...
the Keyfactor Command Portal
   ...
   | Name | Display Name | Description | Type | Default Value/Options | Required |
   | ---- | ------------ | ---- | --------------------- | -------- | ----------- |
   | AutoGenerateAlias | Auto Generate Alias | Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below. | Bool | False | ✅ Checked |
   | AutoGeneratedAliasFormat | Auto Generated Alias Format | Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below. | Bool | CN,Thumbprint,SerialNumber,CN-Thumbprint,CN-SerialNumber | ✅ Checked |
   | KeepSameAliasOnRenewal | Keep Same Alias on Renewal | When Auto Generate Alias is selected, select this if you wish to keep the same alias on renewal instead of recalculating a new alias based on the alias format above. | Bool | False | ✅ Checked |
   | PrimaryNodeOnlineRequired | Primary Node Online Required | Select the format for auto generated aliases when adding new certificates. | MultipleChoice | CN,Thumbprint,SerialNumber,CN-Thumbprint,CN-SerialNumber | ✅ Checked |
   | PrimaryNode | Primary Node | Only required (and shown) if Primary Node Online Required is added and selected.  Enter the Host Name of the F5 device that acts as the primary node in a highly available F5 implementation. Please note that this value IS case sensitive. | String |  | ✅ Checked |
   | PrimaryNodeCheckRetryWaitSecs | Primary Node Check Retry Wait Seconds | Enter the number of seconds to wait between attempts to add/replace/renew a certificate if the node is inactive. | String | 120 | ✅ Checked |
   | PrimaryNodeCheckRetryMax | Primary Node Check Retry Maximum | Enter the number of times a Management-Add job will attempt to add/replace/renew a certificate if the node is inactive before failing. | String | 3 | ✅ Checked |
   | IgnoreSSLWarning | Ignore SSL Warning | Select this if you wish to ignore SSL warnings from F5 that occur during API calls when the site does not have a trusted certificate with the proper SAN bound to it. If you choose not to add this custom field, the default value of False will be assumed and SSL warnings will cause errors during orchestrator extension jobs. | Bool | False | ✅ Checked |
   ...
   ###### Auto Generate Alias
   Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below.

   ![F5-PF-REST Custom Field - AutoGenerateAlias](docsource/images/F5-PF-REST-custom-field-AutoGenerateAlias-dialog.svg)
   ![F5-PF-REST Custom Field - AutoGenerateAlias](docsource/images/F5-PF-REST-custom-field-AutoGenerateAlias-validation-options-dialog.svg)


   ###### Auto Generated Alias Format
   Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below.

   ![F5-PF-REST Custom Field - AutoGeneratedAliasFormat](docsource/images/F5-PF-REST-custom-field-AutoGeneratedAliasFormat-dialog.svg)
   ![F5-PF-REST Custom Field - AutoGeneratedAliasFormat](docsource/images/F5-PF-REST-custom-field-AutoGeneratedAliasFormat-validation-options-dialog.svg)


   ###### Keep Same Alias on Renewal
   When Auto Generate Alias is selected, select this if you wish to keep the same alias on renewal instead of recalculating a new alias based on the alias format above.

   ![F5-PF-REST Custom Field - KeepSameAliasOnRenewal](docsource/images/F5-PF-REST-custom-field-KeepSameAliasOnRenewal-dialog.svg)
   ![F5-PF-REST Custom Field - KeepSameAliasOnRenewal](docsource/images/F5-PF-REST-custom-field-KeepSameAliasOnRenewal-validation-options-dialog.svg)


   ###### Primary Node Online Required
   Select the format for auto generated aliases when adding new certificates.
...
2. **Add a Certificate Store.**
   ...
   | AutoGenerateAlias | Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below. |
   | AutoGeneratedAliasFormat | Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below. |
   | KeepSameAliasOnRenewal | When Auto Generate Alias is selected, select this if you wish to keep the same alias on renewal instead of recalculating a new alias based on the alias format above. |
   | PrimaryNodeOnlineRequired | Select the format for auto generated aliases when adding new certificates. |
   | PrimaryNode | Only required (and shown) if Primary Node Online Required is added and selected.  Enter the Host Name of the F5 device that acts as the primary node in a highly available F5 implementation. Please note that this value IS case sensitive. |
   | PrimaryNodeCheckRetryWaitSecs | Enter the number of seconds to wait between attempts to add/replace/renew a certificate if the node is inactive. |
   | PrimaryNodeCheckRetryMax | Enter the number of times a Management-Add job will attempt to add/replace/renew a certificate if the node is inactive before failing. |
   | IgnoreSSLWarning | Select this if you wish to ignore SSL warnings from F5 that occur during API calls when the site does not have a trusted certificate with the proper SAN bound to it. If you choose not to add this custom field, the default value of False will be assumed and SSL warnings will cause errors during orchestrator extension jobs. |
...
2. **Populate the generated CSV file**
   ...
   | Store Password | Check "No Password" if you wish the private key of any added certificate to be set to Key Security Type "Normal". Enter a value (either a password or pointer to an installed PAM provider key for the password) to be used to encrypt the private key of any added certificate for Key Security Type of "Password". |
   | Orchestrator | Select an approved orchestrator capable of managing `F5-PF-REST` certificates. Specifically, one with the `F5-PF-REST` capability. |
   | Properties.AutoGenerateAlias | Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below. |
   | Properties.AutoGeneratedAliasFormat | Select this if you wish to ignore the entered alias on Management-Add jobs and automatically derive the alias based on your selection for the alias format below. |
   | Properties.KeepSameAliasOnRenewal | When Auto Generate Alias is selected, select this if you wish to keep the same alias on renewal instead of recalculating a new alias based on the alias format above. |
   | Properties.PrimaryNodeOnlineRequired | Select the format for auto generated aliases when adding new certificates. |
   | Properties.PrimaryNode | Only required (and shown) if Primary Node Online Required is added and selected.  Enter the Host Name of the F5 device that acts as the primary node in a highly available F5 implementation. Please note that this value IS case sensitive. |
   | Properties.PrimaryNodeCheckRetryWaitSecs | Enter the number of seconds to wait between attempts to add/replace/renew a certificate if the node is inactive. |
   | Properties.PrimaryNodeCheckRetryMax | Enter the number of times a Management-Add job will attempt to add/replace/renew a certificate if the node is inactive before failing. |
   | Properties.IgnoreSSLWarning | Select this if you wish to ignore SSL warnings from F5 that occur during API calls when the site does not have a trusted certificate with the proper SAN bound to it. If you choose not to add this custom field, the default value of False will be assumed and SSL warnings will cause errors during orchestrator extension jobs. |
