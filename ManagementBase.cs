...
namespace Keyfactor.Extensions.Orchestrator.F5Orchestrator
{
    public abstract class ManagementBase : F5JobBase, IManagementJobExtension
    {
        ...
        protected bool AutoGenerateAlias { get; set; }
        protected string AutoGeneratedAliasFormat { get; set; }
        protected bool KeepSameAliasOnRenewal { get; set; }
        ...
        protected void ParseStoreProperties()
        {
            ...
            AutoGenerateAlias = properties.AutoGenerateAlias == null || string.IsNullOrEmpty(properties.AutoGenerateAlias.Value) ? false : bool.Parse(properties.AutoGenerateAlias.Value);
            AutoGeneratedAliasFormat = properties.AutoGeneratedAliasFormat == null || string.IsNullOrEmpty(properties.AutoGeneratedAliasFormat.Value) ? string.Empty : properties.AutoGeneratedAliasFormat.Value.ToString();
            KeepSameAliasOnRenewal = properties.KeepSameAliasOnRenewal == null || string.IsNullOrEmpty(properties.KeepSameAliasOnRenewal.Value) ? false : bool.Parse(properties.KeepSameAliasOnRenewal.Value);
